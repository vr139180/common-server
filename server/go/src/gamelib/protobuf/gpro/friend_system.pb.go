...
type Frd_FriendListReq struct {
	...
	LastInvite int64 `protobuf:"varint,1,opt,name=last_invite,json=lastInvite,proto3" json:"last_invite,omitempty"`
	//根据活跃度排行的索引 0开始
	Friendindex int32 `protobuf:"varint,2,opt,name=friendindex,proto3" json:"friendindex,omitempty"`
...
type Frd_FriendListAck struct {
	...
	//iid从小到大
	Invites     []*FriendInviteItem `protobuf:"bytes,1,rep,name=invites,proto3" json:"invites,omitempty"`
	Totleinvite int32               `protobuf:"varint,2,opt,name=totleinvite,proto3" json:"totleinvite,omitempty"`
	Friends     []*FriendRelation   `protobuf:"bytes,3,rep,name=friends,proto3" json:"friends,omitempty"`
	Totlefriend int32               `protobuf:"varint,4,opt,name=totlefriend,proto3" json:"totlefriend,omitempty"`
...
type Frd_FriendInviteReq struct {
	...
	//被邀请人
	InviteIid int64 `protobuf:"varint,1,opt,name=invite_iid,json=inviteIid,proto3" json:"invite_iid,omitempty"`
}
...
type Frd_FriendInviteAck struct {
	...
	//成功包含invite信息
	Invite *FriendInviteItem `protobuf:"bytes,3,opt,name=invite,proto3,oneof" json:"invite,omitempty"`
}
...
type Frd_InviteConfirmAck struct {
	...
	//成功 并且同意 返回好友关系
	Friend *FriendRelation `protobuf:"bytes,4,opt,name=friend,proto3,oneof" json:"friend,omitempty"`
}
...
type Frd_FriendDeleteReq struct {
	...
	//好友
	Friendiid int64 `protobuf:"varint,1,opt,name=friendiid,proto3" json:"friendiid,omitempty"`
}
...
var file_friend_system_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x99, 0x01, 0x0a, 0x12, 0x46, 0x72, 0x64, 0x5f, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64,
	0x4c, 0x69, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x71, 0x12, 0x1f, 0x0a, 0x0b, 0x6c, 0x61, 0x73, 0x74,
	0x5f, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x6c,
	0x61, 0x73, 0x74, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x66, 0x72, 0x69,
	0x65, 0x6e, 0x64, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b,
	0x66, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x12, 0x0a, 0x04, 0x6e,
	...
	,
...
var file_friend_system_proto_goTypes = []interface{}{
	...
	(*FriendInviteItem)(nil),     // 8: PRO.FriendInviteItem
	(*FriendRelation)(nil),       // 9: PRO.FriendRelation
}
var file_friend_system_proto_depIdxs = []int32{
	8, // 0: PRO.Frd_FriendList_ack.invites:type_name -> PRO.FriendInviteItem
	9, // 1: PRO.Frd_FriendList_ack.friends:type_name -> PRO.FriendRelation
	8, // 2: PRO.Frd_FriendInvite_ack.invite:type_name -> PRO.FriendInviteItem
	9, // 3: PRO.Frd_InviteConfirm_ack.friend:type_name -> PRO.FriendRelation

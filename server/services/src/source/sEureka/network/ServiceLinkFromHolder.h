...
#ifndef __SERVICELINKFROMHOLDER_H__
#define __SERVICELINKFROMHOLDER_H__
...
template<typename T>
ServiceLinkFromHolder<T>::ServiceLinkFromHolder()
{
}
...
template<typename T>
void ServiceLinkFromHolder<T>::init_holder()
{
	ThreadLockWrapper guard(lock_);
}

template<typename T>
void ServiceLinkFromHolder<T>::uninit_holder()
{
	ThreadLockWrapper guard(lock_);
...
template<typename T>
T* ServiceLinkFromHolder<T>::ask_free_link()
{
	ThreadLockWrapper guard(lock_);
...
template<typename T>
void ServiceLinkFromHolder<T>::return_freelink(T* link)
{
	ThreadLockWrapper guard(lock_);
...
template<typename T>
T* ServiceLinkFromHolder<T>::regist_onlinelink(T* link)
{
	ThreadLockWrapper guard(lock_);
...
template<typename T>
T* ServiceLinkFromHolder<T>::get_servicelink_byiid(S_INT_64 iid)
{
	ThreadLockWrapper guard(lock_);
...
#endif //__SERVICELINKFROMHOLDER_H__
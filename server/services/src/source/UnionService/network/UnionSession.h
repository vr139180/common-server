#ifndef __UNIONSESSION_H__
#define __UNIONSESSION_H__
...
class UnionSession : public NetSessionBindEvent
{
public:
	UnionSession();
	virtual ~UnionSession();

	boost::shared_ptr<NetSession> get_session() { return session_; }

	void set_netlinkbase(NetLinkFromBase<UnionSession>* p) { parent_ = p; }
...
protected:
	...
	NetLinkFromBase<UnionSession>*	parent_;
};

#endif //__UNIONSESSION_H__
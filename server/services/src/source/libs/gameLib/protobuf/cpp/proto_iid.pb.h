...
enum USER_PROTYPE : int {
  ...
  USER_MYSIMPLEINFO_REQ = 1028,
  USER_MYSIMPLEINFO_ACK = 1029,
...
constexpr USER_PROTYPE USER_PROTYPE_MAX = USER_MYSIMPLEINFO_ACK;
...
enum GMS_PROTYPE : int {
  ...
  GMS_ENTERGAME_ACK = 4002,
  GMS_USERSVISIBLE_NTF = 4003,
  GMS_SERVICEDISABLE_NTF = 4004,
  GMS_USERINFO_SYNC = 4005,
  GMS_USERSTATE_SYN = 4011,
  GMS_MSG_END = 4900,
  GMS_USERALIVE_NTF = 4901,
  GMS_MSGALL_END = 4999,

...
constexpr Svr_GateBindHome_req::Svr_GateBindHome_req(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : gateiid_(int64_t{0})
  , gatetoken_(int64_t{0}){}
struct Svr_GateBindHome_reqDefaultTypeInternal {
  constexpr Svr_GateBindHome_reqDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~Svr_GateBindHome_reqDefaultTypeInternal() {}
  union {
    Svr_GateBindHome_req _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT Svr_GateBindHome_reqDefaultTypeInternal _Svr_GateBindHome_req_default_instance_;
constexpr Svr_GateBindHome_ack::Svr_GateBindHome_ack(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : homeip_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , gateiid_(int64_t{0})
  , homeiid_(int64_t{0})
  , result_(0)
  , homeport_(0)
...
struct Svr_GateBindHome_ackDefaultTypeInternal {
  constexpr Svr_GateBindHome_ackDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~Svr_GateBindHome_ackDefaultTypeInternal() {}
  union {
    Svr_GateBindHome_ack _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT Svr_GateBindHome_ackDefaultTypeInternal _Svr_GateBindHome_ack_default_instance_;
constexpr Svr_GateBindHome_confirm::Svr_GateBindHome_confirm(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : gateiid_(int64_t{0})
  , homeiid_(int64_t{0})
  , hometoken_(int64_t{0})
...
struct Svr_GateBindHome_confirmDefaultTypeInternal {
  constexpr Svr_GateBindHome_confirmDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~Svr_GateBindHome_confirmDefaultTypeInternal() {}
  union {
    Svr_GateBindHome_confirm _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT Svr_GateBindHome_confirmDefaultTypeInternal _Svr_GateBindHome_confirm_default_instance_;
}  // namespace PRO
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_eureka_5finternal_2eproto[24];
...
const uint32_t TableStruct_eureka_5finternal_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_req, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_req, gateiid_),
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_req, gatetoken_),
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_ack, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_ack, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_ack, result_),
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_ack, gateiid_),
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_ack, homeiid_),
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_ack, hometoken_),
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_ack, homeip_),
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_ack, homeport_),
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_ack, bindtoken_),
  ~0u,
  1,
  2,
  4,
  ...
  5,
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_confirm, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_confirm, gateiid_),
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_confirm, homeiid_),
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_confirm, hometoken_),
  PROTOBUF_FIELD_OFFSET(::PRO::Svr_GateBindHome_confirm, bindtoken_),
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::PRO::_Svr_GateBindHome_req_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::PRO::_Svr_GateBindHome_ack_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::PRO::_Svr_GateBindHome_confirm_default_instance_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_eureka_5finternal_2eproto = {
  false, false, 2633, descriptor_table_protodef_eureka_5finternal_2eproto, "eureka_internal.proto", 
...
class Svr_GateBindHome_req::_Internal {
 public:
};

Svr_GateBindHome_req::Svr_GateBindHome_req(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  if (!is_message_owned) {
  ...
  // @@protoc_insertion_point(arena_constructor:PRO.Svr_GateBindHome_req)
}
Svr_GateBindHome_req::Svr_GateBindHome_req(const Svr_GateBindHome_req& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&gateiid_, &from.gateiid_,
    static_cast<size_t>(reinterpret_cast<char*>(&gatetoken_) -
    reinterpret_cast<char*>(&gateiid_)) + sizeof(gatetoken_));
  // @@protoc_insertion_point(copy_constructor:PRO.Svr_GateBindHome_req)
}

inline void Svr_GateBindHome_req::SharedCtor() {
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&gateiid_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&gatetoken_) -
    reinterpret_cast<char*>(&gateiid_)) + sizeof(gatetoken_));
}

Svr_GateBindHome_req::~Svr_GateBindHome_req() {
  // @@protoc_insertion_point(destructor:PRO.Svr_GateBindHome_req)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void Svr_GateBindHome_req::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void Svr_GateBindHome_req::ArenaDtor(void* object) {
  Svr_GateBindHome_req* _this = reinterpret_cast< Svr_GateBindHome_req* >(object);
  (void)_this;
}
void Svr_GateBindHome_req::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void Svr_GateBindHome_req::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void Svr_GateBindHome_req::Clear() {
// @@protoc_insertion_point(message_clear_start:PRO.Svr_GateBindHome_req)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;

  ::memset(&gateiid_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&gatetoken_) -
      reinterpret_cast<char*>(&gateiid_)) + sizeof(gatetoken_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

const char* Svr_GateBindHome_req::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          gatetoken_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Svr_GateBindHome_req::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:PRO.Svr_GateBindHome_req)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // int64 gatetoken = 2;
  if (this->_internal_gatetoken() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(2, this->_internal_gatetoken(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:PRO.Svr_GateBindHome_req)
  return target;
}

size_t Svr_GateBindHome_req::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:PRO.Svr_GateBindHome_req)
  size_t total_size = 0;
  ...
  // int64 gatetoken = 2;
  if (this->_internal_gatetoken() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_gatetoken());
  }

  return MaybeComputeUnknownFieldsSize(total_size, &_cached_size_);
}

const ::PROTOBUF_NAMESPACE_ID::Message::ClassData Svr_GateBindHome_req::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    Svr_GateBindHome_req::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*Svr_GateBindHome_req::GetClassData() const { return &_class_data_; }

void Svr_GateBindHome_req::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<Svr_GateBindHome_req *>(to)->MergeFrom(
      static_cast<const Svr_GateBindHome_req &>(from));
}


void Svr_GateBindHome_req::MergeFrom(const Svr_GateBindHome_req& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:PRO.Svr_GateBindHome_req)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from._internal_gatetoken() != 0) {
    _internal_set_gatetoken(from._internal_gatetoken());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void Svr_GateBindHome_req::CopyFrom(const Svr_GateBindHome_req& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:PRO.Svr_GateBindHome_req)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Svr_GateBindHome_req::IsInitialized() const {
  return true;
}

void Svr_GateBindHome_req::InternalSwap(Svr_GateBindHome_req* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Svr_GateBindHome_req, gatetoken_)
      + sizeof(Svr_GateBindHome_req::gatetoken_)
      - PROTOBUF_FIELD_OFFSET(Svr_GateBindHome_req, gateiid_)>(
          reinterpret_cast<char*>(&gateiid_),
          reinterpret_cast<char*>(&other->gateiid_));
}

::PROTOBUF_NAMESPACE_ID::Metadata Svr_GateBindHome_req::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_eureka_5finternal_2eproto_getter, &descriptor_table_eureka_5finternal_2eproto_once,
...
class Svr_GateBindHome_ack::_Internal {
 public:
  using HasBits = decltype(std::declval<Svr_GateBindHome_ack>()._has_bits_);
  static void set_has_gateiid(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
  static void set_has_homeiid(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
  static void set_has_hometoken(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
  static void set_has_homeip(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static void set_has_homeport(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
  static void set_has_bindtoken(HasBits* has_bits) {
    (*has_bits)[0] |= 32u;
  }
};

Svr_GateBindHome_ack::Svr_GateBindHome_ack(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  if (!is_message_owned) {
  ...
  // @@protoc_insertion_point(arena_constructor:PRO.Svr_GateBindHome_ack)
}
Svr_GateBindHome_ack::Svr_GateBindHome_ack(const Svr_GateBindHome_ack& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _has_bits_(from._has_bits_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  homeip_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    homeip_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_homeip()) {
    homeip_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_homeip(), 
      GetArenaForAllocation());
  }
  ::memcpy(&gateiid_, &from.gateiid_,
    static_cast<size_t>(reinterpret_cast<char*>(&bindtoken_) -
    reinterpret_cast<char*>(&gateiid_)) + sizeof(bindtoken_));
  // @@protoc_insertion_point(copy_constructor:PRO.Svr_GateBindHome_ack)
}

inline void Svr_GateBindHome_ack::SharedCtor() {
homeip_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  homeip_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&gateiid_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&bindtoken_) -
    reinterpret_cast<char*>(&gateiid_)) + sizeof(bindtoken_));
}

Svr_GateBindHome_ack::~Svr_GateBindHome_ack() {
  // @@protoc_insertion_point(destructor:PRO.Svr_GateBindHome_ack)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void Svr_GateBindHome_ack::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  homeip_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void Svr_GateBindHome_ack::ArenaDtor(void* object) {
  Svr_GateBindHome_ack* _this = reinterpret_cast< Svr_GateBindHome_ack* >(object);
  (void)_this;
}
void Svr_GateBindHome_ack::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void Svr_GateBindHome_ack::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void Svr_GateBindHome_ack::Clear() {
// @@protoc_insertion_point(message_clear_start:PRO.Svr_GateBindHome_ack)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  cached_has_bits = _has_bits_[0];
  if (cached_has_bits & 0x00000001u) {
    homeip_.ClearNonDefaultToEmpty();
  }
  if (cached_has_bits & 0x00000006u) {
    ::memset(&gateiid_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&homeiid_) -
        reinterpret_cast<char*>(&gateiid_)) + sizeof(homeiid_));
  }
  result_ = 0;
  if (cached_has_bits & 0x00000038u) {
    ::memset(&homeport_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&bindtoken_) -
        reinterpret_cast<char*>(&homeport_)) + sizeof(bindtoken_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

const char* Svr_GateBindHome_ack::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          _Internal::set_has_gateiid(&has_bits);
          gateiid_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          _Internal::set_has_homeiid(&has_bits);
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          _Internal::set_has_hometoken(&has_bits);
          hometoken_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          auto str = _internal_mutable_homeip();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "PRO.Svr_GateBindHome_ack.homeip"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          _Internal::set_has_homeport(&has_bits);
          homeport_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          _Internal::set_has_bindtoken(&has_bits);
          bindtoken_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Svr_GateBindHome_ack::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:PRO.Svr_GateBindHome_ack)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // optional int64 gateiid = 2;
  if (_internal_has_gateiid()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(2, this->_internal_gateiid(), target);
  }

  // optional int64 homeiid = 3;
  if (_internal_has_homeiid()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(3, this->_internal_homeiid(), target);
  }

  // optional int64 hometoken = 4;
  if (_internal_has_hometoken()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(4, this->_internal_hometoken(), target);
  }

  // optional string homeip = 5;
  if (_internal_has_homeip()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_homeip().data(), static_cast<int>(this->_internal_homeip().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "PRO.Svr_GateBindHome_ack.homeip");
    target = stream->WriteStringMaybeAliased(
        5, this->_internal_homeip(), target);
  }

  // optional int32 homeport = 6;
  if (_internal_has_homeport()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(6, this->_internal_homeport(), target);
  }

  // optional int64 bindtoken = 7;
  if (_internal_has_bindtoken()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(7, this->_internal_bindtoken(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:PRO.Svr_GateBindHome_ack)
  return target;
}

size_t Svr_GateBindHome_ack::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:PRO.Svr_GateBindHome_ack)
  size_t total_size = 0;
  ...
  if (cached_has_bits & 0x00000038u) {
    // optional int32 homeport = 6;
    if (cached_has_bits & 0x00000008u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_homeport());
    }

    // optional int64 hometoken = 4;
    if (cached_has_bits & 0x00000010u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_hometoken());
    }

    // optional int64 bindtoken = 7;
    if (cached_has_bits & 0x00000020u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_bindtoken());
    }
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData Svr_GateBindHome_ack::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    Svr_GateBindHome_ack::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*Svr_GateBindHome_ack::GetClassData() const { return &_class_data_; }

void Svr_GateBindHome_ack::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<Svr_GateBindHome_ack *>(to)->MergeFrom(
      static_cast<const Svr_GateBindHome_ack &>(from));
}


void Svr_GateBindHome_ack::MergeFrom(const Svr_GateBindHome_ack& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:PRO.Svr_GateBindHome_ack)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
      _internal_set_homeip(from._internal_homeip());
    }
    if (cached_has_bits & 0x00000002u) {
      gateiid_ = from.gateiid_;
    }
    if (cached_has_bits & 0x00000004u) {
      homeiid_ = from.homeiid_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  if (from._internal_result() != 0) {
  ...
  if (cached_has_bits & 0x00000038u) {
    if (cached_has_bits & 0x00000008u) {
      homeport_ = from.homeport_;
    }
    if (cached_has_bits & 0x00000010u) {
      hometoken_ = from.hometoken_;
    }
    if (cached_has_bits & 0x00000020u) {
      bindtoken_ = from.bindtoken_;
    }
    _has_bits_[0] |= cached_has_bits;
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
void Svr_GateBindHome_ack::CopyFrom(const Svr_GateBindHome_ack& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:PRO.Svr_GateBindHome_ack)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Svr_GateBindHome_ack::IsInitialized() const {
  return true;
}

void Svr_GateBindHome_ack::InternalSwap(Svr_GateBindHome_ack* other) {
  using std::swap;
  auto* lhs_arena = GetArenaForAllocation();
  auto* rhs_arena = other->GetArenaForAllocation();
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &homeip_, lhs_arena,
      &other->homeip_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Svr_GateBindHome_ack, bindtoken_)
      + sizeof(Svr_GateBindHome_ack::bindtoken_)
      - PROTOBUF_FIELD_OFFSET(Svr_GateBindHome_ack, gateiid_)>(
          reinterpret_cast<char*>(&gateiid_),
          reinterpret_cast<char*>(&other->gateiid_));
}

::PROTOBUF_NAMESPACE_ID::Metadata Svr_GateBindHome_ack::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_eureka_5finternal_2eproto_getter, &descriptor_table_eureka_5finternal_2eproto_once,
...
class Svr_GateBindHome_confirm::_Internal {
 public:
};

Svr_GateBindHome_confirm::Svr_GateBindHome_confirm(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  if (!is_message_owned) {
  ...
  // @@protoc_insertion_point(arena_constructor:PRO.Svr_GateBindHome_confirm)
}
Svr_GateBindHome_confirm::Svr_GateBindHome_confirm(const Svr_GateBindHome_confirm& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&gateiid_, &from.gateiid_,
    static_cast<size_t>(reinterpret_cast<char*>(&bindtoken_) -
    reinterpret_cast<char*>(&gateiid_)) + sizeof(bindtoken_));
  // @@protoc_insertion_point(copy_constructor:PRO.Svr_GateBindHome_confirm)
}

inline void Svr_GateBindHome_confirm::SharedCtor() {
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&gateiid_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&bindtoken_) -
    reinterpret_cast<char*>(&gateiid_)) + sizeof(bindtoken_));
...
Svr_GateBindHome_confirm::~Svr_GateBindHome_confirm() {
  // @@protoc_insertion_point(destructor:PRO.Svr_GateBindHome_confirm)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void Svr_GateBindHome_confirm::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void Svr_GateBindHome_confirm::ArenaDtor(void* object) {
  Svr_GateBindHome_confirm* _this = reinterpret_cast< Svr_GateBindHome_confirm* >(object);
  (void)_this;
}
void Svr_GateBindHome_confirm::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void Svr_GateBindHome_confirm::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void Svr_GateBindHome_confirm::Clear() {
// @@protoc_insertion_point(message_clear_start:PRO.Svr_GateBindHome_confirm)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* Svr_GateBindHome_confirm::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
uint8_t* Svr_GateBindHome_confirm::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:PRO.Svr_GateBindHome_confirm)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->_internal_homeiid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(2, this->_internal_homeiid(), target);
  }

  // int64 hometoken = 3;
  if (this->_internal_hometoken() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(3, this->_internal_hometoken(), target);
  }

  // int64 bindtoken = 4;
  if (this->_internal_bindtoken() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(4, this->_internal_bindtoken(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:PRO.Svr_GateBindHome_confirm)
  return target;
}

size_t Svr_GateBindHome_confirm::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:PRO.Svr_GateBindHome_confirm)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData Svr_GateBindHome_confirm::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    Svr_GateBindHome_confirm::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*Svr_GateBindHome_confirm::GetClassData() const { return &_class_data_; }

void Svr_GateBindHome_confirm::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<Svr_GateBindHome_confirm *>(to)->MergeFrom(
      static_cast<const Svr_GateBindHome_confirm &>(from));
}


void Svr_GateBindHome_confirm::MergeFrom(const Svr_GateBindHome_confirm& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:PRO.Svr_GateBindHome_confirm)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from._internal_hometoken() != 0) {
    _internal_set_hometoken(from._internal_hometoken());
  }
  if (from._internal_bindtoken() != 0) {
    _internal_set_bindtoken(from._internal_bindtoken());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void Svr_GateBindHome_confirm::CopyFrom(const Svr_GateBindHome_confirm& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:PRO.Svr_GateBindHome_confirm)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Svr_GateBindHome_confirm::IsInitialized() const {
  return true;
}

void Svr_GateBindHome_confirm::InternalSwap(Svr_GateBindHome_confirm* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Svr_GateBindHome_confirm, bindtoken_)
      + sizeof(Svr_GateBindHome_confirm::bindtoken_)
      - PROTOBUF_FIELD_OFFSET(Svr_GateBindHome_confirm, gateiid_)>(
          reinterpret_cast<char*>(&gateiid_),
          reinterpret_cast<char*>(&other->gateiid_));
}

::PROTOBUF_NAMESPACE_ID::Metadata Svr_GateBindHome_confirm::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_eureka_5finternal_2eproto_getter, &descriptor_table_eureka_5finternal_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::PRO::Svr_GateBindHome_req* Arena::CreateMaybeMessage< ::PRO::Svr_GateBindHome_req >(Arena* arena) {
  return Arena::CreateMessageInternal< ::PRO::Svr_GateBindHome_req >(arena);
}
template<> PROTOBUF_NOINLINE ::PRO::Svr_GateBindHome_ack* Arena::CreateMaybeMessage< ::PRO::Svr_GateBindHome_ack >(Arena* arena) {
  return Arena::CreateMessageInternal< ::PRO::Svr_GateBindHome_ack >(arena);
}
template<> PROTOBUF_NOINLINE ::PRO::Svr_GateBindHome_confirm* Arena::CreateMaybeMessage< ::PRO::Svr_GateBindHome_confirm >(Arena* arena) {
  return Arena::CreateMessageInternal< ::PRO::Svr_GateBindHome_confirm >(arena);
}

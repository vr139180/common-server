...
class Svr_GateBindHome_ack;
struct Svr_GateBindHome_ackDefaultTypeInternal;
extern Svr_GateBindHome_ackDefaultTypeInternal _Svr_GateBindHome_ack_default_instance_;
class Svr_GateBindHome_confirm;
struct Svr_GateBindHome_confirmDefaultTypeInternal;
extern Svr_GateBindHome_confirmDefaultTypeInternal _Svr_GateBindHome_confirm_default_instance_;
class Svr_GateBindHome_req;
struct Svr_GateBindHome_reqDefaultTypeInternal;
extern Svr_GateBindHome_reqDefaultTypeInternal _Svr_GateBindHome_req_default_instance_;
...
template<> ::PRO::Svr_GateBindHome_ack* Arena::CreateMaybeMessage<::PRO::Svr_GateBindHome_ack>(Arena*);
template<> ::PRO::Svr_GateBindHome_confirm* Arena::CreateMaybeMessage<::PRO::Svr_GateBindHome_confirm>(Arena*);
template<> ::PRO::Svr_GateBindHome_req* Arena::CreateMaybeMessage<::PRO::Svr_GateBindHome_req>(Arena*);
...
class Svr_GateBindHome_req final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PRO.Svr_GateBindHome_req) */ {
 public:
  inline Svr_GateBindHome_req() : Svr_GateBindHome_req(nullptr) {}
  ~Svr_GateBindHome_req() override;
  explicit constexpr Svr_GateBindHome_req(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  Svr_GateBindHome_req(const Svr_GateBindHome_req& from);
  Svr_GateBindHome_req(Svr_GateBindHome_req&& from) noexcept
    : Svr_GateBindHome_req() {
    *this = ::std::move(from);
  }

  inline Svr_GateBindHome_req& operator=(const Svr_GateBindHome_req& from) {
    CopyFrom(from);
    return *this;
  }
  inline Svr_GateBindHome_req& operator=(Svr_GateBindHome_req&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const Svr_GateBindHome_req& default_instance() {
    return *internal_default_instance();
  }
  static inline const Svr_GateBindHome_req* internal_default_instance() {
    return reinterpret_cast<const Svr_GateBindHome_req*>(
               &_Svr_GateBindHome_req_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    21;

  friend void swap(Svr_GateBindHome_req& a, Svr_GateBindHome_req& b) {
    a.Swap(&b);
  }
  inline void Swap(Svr_GateBindHome_req* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(Svr_GateBindHome_req* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  Svr_GateBindHome_req* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<Svr_GateBindHome_req>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const Svr_GateBindHome_req& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const Svr_GateBindHome_req& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Svr_GateBindHome_req* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "PRO.Svr_GateBindHome_req";
  }
  protected:
  explicit Svr_GateBindHome_req(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  int64_t gatetoken() const;
  void set_gatetoken(int64_t value);
  private:
  int64_t _internal_gatetoken() const;
  void _internal_set_gatetoken(int64_t value);
  public:

  // @@protoc_insertion_point(class_scope:PRO.Svr_GateBindHome_req)
 private:
  class _Internal;
...
class Svr_GateBindHome_ack final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PRO.Svr_GateBindHome_ack) */ {
 public:
  inline Svr_GateBindHome_ack() : Svr_GateBindHome_ack(nullptr) {}
  ~Svr_GateBindHome_ack() override;
  explicit constexpr Svr_GateBindHome_ack(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  Svr_GateBindHome_ack(const Svr_GateBindHome_ack& from);
  Svr_GateBindHome_ack(Svr_GateBindHome_ack&& from) noexcept
    : Svr_GateBindHome_ack() {
    *this = ::std::move(from);
  }

  inline Svr_GateBindHome_ack& operator=(const Svr_GateBindHome_ack& from) {
    CopyFrom(from);
    return *this;
  }
  inline Svr_GateBindHome_ack& operator=(Svr_GateBindHome_ack&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const Svr_GateBindHome_ack& default_instance() {
    return *internal_default_instance();
  }
  static inline const Svr_GateBindHome_ack* internal_default_instance() {
    return reinterpret_cast<const Svr_GateBindHome_ack*>(
               &_Svr_GateBindHome_ack_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    22;

  friend void swap(Svr_GateBindHome_ack& a, Svr_GateBindHome_ack& b) {
    a.Swap(&b);
  }
  inline void Swap(Svr_GateBindHome_ack* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(Svr_GateBindHome_ack* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  Svr_GateBindHome_ack* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<Svr_GateBindHome_ack>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const Svr_GateBindHome_ack& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const Svr_GateBindHome_ack& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Svr_GateBindHome_ack* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "PRO.Svr_GateBindHome_ack";
  }
  protected:
  explicit Svr_GateBindHome_ack(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  enum : int {
    kHomeipFieldNumber = 5,
    kGateiidFieldNumber = 2,
    kHomeiidFieldNumber = 3,
    kResultFieldNumber = 1,
    kHomeportFieldNumber = 6,
    kHometokenFieldNumber = 4,
    kBindtokenFieldNumber = 7,
  };
  // optional string homeip = 5;
  bool has_homeip() const;
  private:
  bool _internal_has_homeip() const;
  public:
  void clear_homeip();
  const std::string& homeip() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_homeip(ArgT0&& arg0, ArgT... args);
  std::string* mutable_homeip();
  PROTOBUF_NODISCARD std::string* release_homeip();
  void set_allocated_homeip(std::string* homeip);
  private:
  const std::string& _internal_homeip() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_homeip(const std::string& value);
  std::string* _internal_mutable_homeip();
  public:

  // optional int64 gateiid = 2;
  bool has_gateiid() const;
  private:
  bool _internal_has_gateiid() const;
  public:
  void clear_gateiid();
  int64_t gateiid() const;
  void set_gateiid(int64_t value);
  ...
  // optional int64 homeiid = 3;
  bool has_homeiid() const;
  private:
  bool _internal_has_homeiid() const;
  public:
  void clear_homeiid();
  ...
  // optional int32 homeport = 6;
  bool has_homeport() const;
  private:
  bool _internal_has_homeport() const;
  public:
  void clear_homeport();
  int32_t homeport() const;
  void set_homeport(int32_t value);
  private:
  int32_t _internal_homeport() const;
  void _internal_set_homeport(int32_t value);
  public:

  // optional int64 hometoken = 4;
  bool has_hometoken() const;
  private:
  bool _internal_has_hometoken() const;
  public:
  void clear_hometoken();
  int64_t hometoken() const;
  void set_hometoken(int64_t value);
  private:
  int64_t _internal_hometoken() const;
  void _internal_set_hometoken(int64_t value);
  public:

  // optional int64 bindtoken = 7;
  bool has_bindtoken() const;
  private:
  bool _internal_has_bindtoken() const;
  public:
  void clear_bindtoken();
  int64_t bindtoken() const;
  void set_bindtoken(int64_t value);
  private:
  int64_t _internal_bindtoken() const;
  void _internal_set_bindtoken(int64_t value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr homeip_;
  int64_t gateiid_;
  int64_t homeiid_;
  int32_t result_;
  int32_t homeport_;
...
class Svr_GateBindHome_confirm final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PRO.Svr_GateBindHome_confirm) */ {
 public:
  inline Svr_GateBindHome_confirm() : Svr_GateBindHome_confirm(nullptr) {}
  ~Svr_GateBindHome_confirm() override;
  explicit constexpr Svr_GateBindHome_confirm(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  Svr_GateBindHome_confirm(const Svr_GateBindHome_confirm& from);
  Svr_GateBindHome_confirm(Svr_GateBindHome_confirm&& from) noexcept
    : Svr_GateBindHome_confirm() {
    *this = ::std::move(from);
  }

  inline Svr_GateBindHome_confirm& operator=(const Svr_GateBindHome_confirm& from) {
    CopyFrom(from);
    return *this;
  }
  inline Svr_GateBindHome_confirm& operator=(Svr_GateBindHome_confirm&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const Svr_GateBindHome_confirm& default_instance() {
    return *internal_default_instance();
  }
  static inline const Svr_GateBindHome_confirm* internal_default_instance() {
    return reinterpret_cast<const Svr_GateBindHome_confirm*>(
               &_Svr_GateBindHome_confirm_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    23;

  friend void swap(Svr_GateBindHome_confirm& a, Svr_GateBindHome_confirm& b) {
    a.Swap(&b);
  }
  inline void Swap(Svr_GateBindHome_confirm* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(Svr_GateBindHome_confirm* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  Svr_GateBindHome_confirm* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<Svr_GateBindHome_confirm>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const Svr_GateBindHome_confirm& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const Svr_GateBindHome_confirm& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Svr_GateBindHome_confirm* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "PRO.Svr_GateBindHome_confirm";
  }
  protected:
  explicit Svr_GateBindHome_confirm(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  enum : int {
    kGateiidFieldNumber = 1,
    kHomeiidFieldNumber = 2,
    kHometokenFieldNumber = 3,
    kBindtokenFieldNumber = 4,
  };
  // int64 gateiid = 1;
  void clear_gateiid();
  int64_t gateiid() const;
...
// int64 gateiid = 1;
inline void Svr_GateBindHome_req::clear_gateiid() {
  gateiid_ = int64_t{0};
}
inline int64_t Svr_GateBindHome_req::_internal_gateiid() const {
  return gateiid_;
}
inline int64_t Svr_GateBindHome_req::gateiid() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_req.gateiid)
  return _internal_gateiid();
}
inline void Svr_GateBindHome_req::_internal_set_gateiid(int64_t value) {
  
  gateiid_ = value;
}
inline void Svr_GateBindHome_req::set_gateiid(int64_t value) {
  _internal_set_gateiid(value);
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_req.gateiid)
}

// int64 gatetoken = 2;
inline void Svr_GateBindHome_req::clear_gatetoken() {
  gatetoken_ = int64_t{0};
}
inline int64_t Svr_GateBindHome_req::_internal_gatetoken() const {
  return gatetoken_;
}
inline int64_t Svr_GateBindHome_req::gatetoken() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_req.gatetoken)
  return _internal_gatetoken();
}
inline void Svr_GateBindHome_req::_internal_set_gatetoken(int64_t value) {
  
  gatetoken_ = value;
}
inline void Svr_GateBindHome_req::set_gatetoken(int64_t value) {
  _internal_set_gatetoken(value);
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_req.gatetoken)
}
...
// int32 result = 1;
inline void Svr_GateBindHome_ack::clear_result() {
  result_ = 0;
}
inline int32_t Svr_GateBindHome_ack::_internal_result() const {
  return result_;
}
inline int32_t Svr_GateBindHome_ack::result() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_ack.result)
  return _internal_result();
}
inline void Svr_GateBindHome_ack::_internal_set_result(int32_t value) {
  
  result_ = value;
}
inline void Svr_GateBindHome_ack::set_result(int32_t value) {
  _internal_set_result(value);
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_ack.result)
}

// optional int64 gateiid = 2;
inline bool Svr_GateBindHome_ack::_internal_has_gateiid() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool Svr_GateBindHome_ack::has_gateiid() const {
  return _internal_has_gateiid();
}
inline void Svr_GateBindHome_ack::clear_gateiid() {
  gateiid_ = int64_t{0};
  _has_bits_[0] &= ~0x00000002u;
}
inline int64_t Svr_GateBindHome_ack::_internal_gateiid() const {
  return gateiid_;
}
inline int64_t Svr_GateBindHome_ack::gateiid() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_ack.gateiid)
  return _internal_gateiid();
}
inline void Svr_GateBindHome_ack::_internal_set_gateiid(int64_t value) {
  _has_bits_[0] |= 0x00000002u;
  gateiid_ = value;
}
inline void Svr_GateBindHome_ack::set_gateiid(int64_t value) {
  _internal_set_gateiid(value);
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_ack.gateiid)
}

// optional int64 homeiid = 3;
inline bool Svr_GateBindHome_ack::_internal_has_homeiid() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool Svr_GateBindHome_ack::has_homeiid() const {
  return _internal_has_homeiid();
}
inline void Svr_GateBindHome_ack::clear_homeiid() {
  homeiid_ = int64_t{0};
  _has_bits_[0] &= ~0x00000004u;
}
inline int64_t Svr_GateBindHome_ack::_internal_homeiid() const {
  return homeiid_;
}
inline int64_t Svr_GateBindHome_ack::homeiid() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_ack.homeiid)
  return _internal_homeiid();
}
inline void Svr_GateBindHome_ack::_internal_set_homeiid(int64_t value) {
  _has_bits_[0] |= 0x00000004u;
  homeiid_ = value;
}
inline void Svr_GateBindHome_ack::set_homeiid(int64_t value) {
  _internal_set_homeiid(value);
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_ack.homeiid)
}

// optional int64 hometoken = 4;
inline bool Svr_GateBindHome_ack::_internal_has_hometoken() const {
  bool value = (_has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool Svr_GateBindHome_ack::has_hometoken() const {
  return _internal_has_hometoken();
}
inline void Svr_GateBindHome_ack::clear_hometoken() {
  hometoken_ = int64_t{0};
  _has_bits_[0] &= ~0x00000010u;
}
inline int64_t Svr_GateBindHome_ack::_internal_hometoken() const {
  return hometoken_;
}
inline int64_t Svr_GateBindHome_ack::hometoken() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_ack.hometoken)
  return _internal_hometoken();
}
inline void Svr_GateBindHome_ack::_internal_set_hometoken(int64_t value) {
  _has_bits_[0] |= 0x00000010u;
  hometoken_ = value;
}
inline void Svr_GateBindHome_ack::set_hometoken(int64_t value) {
  _internal_set_hometoken(value);
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_ack.hometoken)
}

// optional string homeip = 5;
inline bool Svr_GateBindHome_ack::_internal_has_homeip() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool Svr_GateBindHome_ack::has_homeip() const {
  return _internal_has_homeip();
}
inline void Svr_GateBindHome_ack::clear_homeip() {
  homeip_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000001u;
}
inline const std::string& Svr_GateBindHome_ack::homeip() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_ack.homeip)
  return _internal_homeip();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Svr_GateBindHome_ack::set_homeip(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 homeip_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_ack.homeip)
}
inline std::string* Svr_GateBindHome_ack::mutable_homeip() {
  std::string* _s = _internal_mutable_homeip();
  // @@protoc_insertion_point(field_mutable:PRO.Svr_GateBindHome_ack.homeip)
  return _s;
}
inline const std::string& Svr_GateBindHome_ack::_internal_homeip() const {
  return homeip_.Get();
}
inline void Svr_GateBindHome_ack::_internal_set_homeip(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  homeip_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Svr_GateBindHome_ack::_internal_mutable_homeip() {
  _has_bits_[0] |= 0x00000001u;
  return homeip_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Svr_GateBindHome_ack::release_homeip() {
  // @@protoc_insertion_point(field_release:PRO.Svr_GateBindHome_ack.homeip)
  if (!_internal_has_homeip()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000001u;
  auto* p = homeip_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (homeip_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    homeip_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void Svr_GateBindHome_ack::set_allocated_homeip(std::string* homeip) {
  if (homeip != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
  }
  homeip_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), homeip,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (homeip_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    homeip_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:PRO.Svr_GateBindHome_ack.homeip)
}

// optional int32 homeport = 6;
inline bool Svr_GateBindHome_ack::_internal_has_homeport() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool Svr_GateBindHome_ack::has_homeport() const {
  return _internal_has_homeport();
}
inline void Svr_GateBindHome_ack::clear_homeport() {
  homeport_ = 0;
  _has_bits_[0] &= ~0x00000008u;
}
inline int32_t Svr_GateBindHome_ack::_internal_homeport() const {
  return homeport_;
}
inline int32_t Svr_GateBindHome_ack::homeport() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_ack.homeport)
  return _internal_homeport();
}
inline void Svr_GateBindHome_ack::_internal_set_homeport(int32_t value) {
  _has_bits_[0] |= 0x00000008u;
  homeport_ = value;
}
inline void Svr_GateBindHome_ack::set_homeport(int32_t value) {
  _internal_set_homeport(value);
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_ack.homeport)
}

// optional int64 bindtoken = 7;
inline bool Svr_GateBindHome_ack::_internal_has_bindtoken() const {
  bool value = (_has_bits_[0] & 0x00000020u) != 0;
  return value;
}
inline bool Svr_GateBindHome_ack::has_bindtoken() const {
  return _internal_has_bindtoken();
}
inline void Svr_GateBindHome_ack::clear_bindtoken() {
  bindtoken_ = int64_t{0};
  _has_bits_[0] &= ~0x00000020u;
}
inline int64_t Svr_GateBindHome_ack::_internal_bindtoken() const {
  return bindtoken_;
}
inline int64_t Svr_GateBindHome_ack::bindtoken() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_ack.bindtoken)
  return _internal_bindtoken();
}
inline void Svr_GateBindHome_ack::_internal_set_bindtoken(int64_t value) {
  _has_bits_[0] |= 0x00000020u;
  bindtoken_ = value;
}
inline void Svr_GateBindHome_ack::set_bindtoken(int64_t value) {
  _internal_set_bindtoken(value);
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_ack.bindtoken)
}
...
// int64 gateiid = 1;
inline void Svr_GateBindHome_confirm::clear_gateiid() {
  gateiid_ = int64_t{0};
}
inline int64_t Svr_GateBindHome_confirm::_internal_gateiid() const {
  return gateiid_;
}
inline int64_t Svr_GateBindHome_confirm::gateiid() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_confirm.gateiid)
  return _internal_gateiid();
}
inline void Svr_GateBindHome_confirm::_internal_set_gateiid(int64_t value) {
  
  gateiid_ = value;
}
inline void Svr_GateBindHome_confirm::set_gateiid(int64_t value) {
  _internal_set_gateiid(value);
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_confirm.gateiid)
}

// int64 homeiid = 2;
inline void Svr_GateBindHome_confirm::clear_homeiid() {
  homeiid_ = int64_t{0};
}
inline int64_t Svr_GateBindHome_confirm::_internal_homeiid() const {
  return homeiid_;
}
inline int64_t Svr_GateBindHome_confirm::homeiid() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_confirm.homeiid)
  return _internal_homeiid();
}
inline void Svr_GateBindHome_confirm::_internal_set_homeiid(int64_t value) {
  
  homeiid_ = value;
}
inline void Svr_GateBindHome_confirm::set_homeiid(int64_t value) {
  _internal_set_homeiid(value);
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_confirm.homeiid)
}

// int64 hometoken = 3;
inline void Svr_GateBindHome_confirm::clear_hometoken() {
  hometoken_ = int64_t{0};
}
inline int64_t Svr_GateBindHome_confirm::_internal_hometoken() const {
  return hometoken_;
}
inline int64_t Svr_GateBindHome_confirm::hometoken() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_confirm.hometoken)
  return _internal_hometoken();
}
inline void Svr_GateBindHome_confirm::_internal_set_hometoken(int64_t value) {
  
  hometoken_ = value;
}
inline void Svr_GateBindHome_confirm::set_hometoken(int64_t value) {
  _internal_set_hometoken(value);
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_confirm.hometoken)
}

// int64 bindtoken = 4;
inline void Svr_GateBindHome_confirm::clear_bindtoken() {
  bindtoken_ = int64_t{0};
}
inline int64_t Svr_GateBindHome_confirm::_internal_bindtoken() const {
  return bindtoken_;
}
inline int64_t Svr_GateBindHome_confirm::bindtoken() const {
  // @@protoc_insertion_point(field_get:PRO.Svr_GateBindHome_confirm.bindtoken)
  return _internal_bindtoken();
}
inline void Svr_GateBindHome_confirm::_internal_set_bindtoken(int64_t value) {
  
  bindtoken_ = value;
}
inline void Svr_GateBindHome_confirm::set_bindtoken(int64_t value) {
  _internal_set_bindtoken(value);
  // @@protoc_insertion_point(field_set:PRO.Svr_GateBindHome_confirm.bindtoken)
}

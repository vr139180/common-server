...
import com.cms.designer.workflow.editor.ProjectExportEditor;
 ...
 * ProjectExportDialog.java,v 1.1.2.1 2004/06/08 03:03:21 gaj Exp $
 */
public class ProjectExportDialog extends JDialog
{
	private static final Log log = LogFactory.getLog( ProjectExportDialog.class);
	...
	//ÏîÄ¿±à¼­
	private ProjectExportEditor editor;

	private JButton okButton;

	private JButton cancelButton;

	public ProjectExportDialog( OBEDesigner parent)
	{
		super( parent);
		this.parent = parent;
		init();
	...
	private void init()
	{
		editor = new ProjectExportEditor( parent);
		setModal( true);
		...
		setTitle( ResourceUtil.getRS( "core.project.export"));
		pack();
	}
